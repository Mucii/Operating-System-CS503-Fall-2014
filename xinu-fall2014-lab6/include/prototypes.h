...
/* in file find_library_function.c */

extern	void *find_library_function(char *);
...
/* in file load_library.c */

extern	syscall	load_library(char *);

/* in file load_program.c */
 ...
 *       */
extern int hashmap_iterate(map_t, PFany , any_t );

/*
 *  * Add an element to the hashmap. Return MAP_OK or MAP_OMEM.
 *   */
extern int hashmap_put(map_t , char* , any_t );

/*
 *  * Get an element from the hashmap. Return MAP_OK or MAP_MISSING.
 *   */
extern int hashmap_get(map_t , char*, any_t*);

/*
 *  * Remove an element from the hashmap. Return MAP_OK or MAP_MISSING.
 *   */
extern int hashmap_remove(map_t, char*);

/*
 *  * Get any element. Return MAP_OK or MAP_MISSING.
 *   * remove - should the element be removed from the hashmap
 *    */
extern int hashmap_get_one(map_t, any_t *, int);

/*
 *  * Free the hashmap
 *   */
extern void hashmap_free(map_t );

/*
 *  * Get the current size of a hashmap
 *   */
extern int hashmap_length(map_t );
extern char *calloc(int32 , int32 );
