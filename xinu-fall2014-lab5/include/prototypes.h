...
/* in file regevent.c */
extern	syscall	regevent(void (*eventhandler)(uint32), uint32);
extern void event_handler(uint32);

extern syscall send_process_event(pid32,uint32,umsg32);
/* in file resched.c */
