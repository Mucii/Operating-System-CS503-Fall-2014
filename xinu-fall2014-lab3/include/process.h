...
#define MYRECV          9       /* Process is waiting for message       */
...
struct procent {		/* Entry in the process table		*/
	...
	buffer_t *prmsgbuf;    //circular buffer for restore message
	uint32  msgreq;		// receiven requirement number for message
};
